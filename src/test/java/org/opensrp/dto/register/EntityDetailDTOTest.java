...
public class EntityDetailDTOTest {
	...
	public void testToStringAndSetters() {
		...
		EntityDetailDTO entityDetailDTO = new EntityDetailDTO().withEntityID(entityId).withEntityType(type)
		        .withThayiCardNumber("").withECNumber("").withANMIdentifier(anmIdentifier);
