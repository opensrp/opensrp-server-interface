...
public class IUDRegisterEntryDTOTest {
	...
	public void testToStringAndSetters() {
		...
		IUDRegisterEntryDTO iudRegisterEntryDTO = new IUDRegisterEntryDTO().withEcNumber("").withWifeName("")
		        .withWifeAge(wifeAge).withWifeEducationLevel("").withHusbandName(husbandName).withHusbandAge(husbandAge)
		        .withHusbandEducationLevel("").withVillage("charpara").withSubCenter("").withReligion("islam")
		        .withNumberOfLivingFemaleChildren("").withNumberOfLivingMaleChildren("").withCaste("").withLmpDate("")
