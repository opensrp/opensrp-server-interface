...
public class MaleSterilizationRegisterEntryDTOTest {
	...
	public void testToStringAndSetters() {
		...
		MaleSterilizationFPDetailsDTO maleSterilizationFPDetailsDTO = new MaleSterilizationFPDetailsDTO(typeOfSterilization,
		...
		MaleSterilizationRegisterEntryDTO maleSterilizationRegisterEntryDTO = new MaleSterilizationRegisterEntryDTO()
		        ...
		        .withHusbandName(husbandName).withHusbandAge(husbandAge).withHusbandEducationLevel("")
		        .withVillage("charpara").withSubCenter("").withReligion("islam").withNumberOfLivingFemaleChildren("")
		        .withNumberOfLivingMaleChildren("").withCaste("").withFpDetails(maleSterilizationFPDetailsDTO);
