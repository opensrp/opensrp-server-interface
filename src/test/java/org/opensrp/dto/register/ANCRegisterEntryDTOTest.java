...
public class ANCRegisterEntryDTOTest {
	...
	public void testWithANCNumber() {
		...
		ANCRegisterEntryDTO ancRegisterEntryDTO = new ANCRegisterEntryDTO().withANCNumber("anc1")
		        .withRegistrationDate("registrationDate").withECNumber("").withThayiCardNumber("").withAadharCardNumber("")
		        .withWifeName("").withHusbandName("").withAddress("").withWifeDOB("").withPhoneNumber("")
		        .withWifeEducationLevel("").withHusbandEducationLevel("").withCaste("").withReligion("")
		        .withEconomicStatus("").withBPLCardNumber("").withJSYBeneficiary("").withGravida("").withParity("")
		        .withNumberOfLivingChildren("").withNumberOfStillBirths("").withNumberOfAbortions("")
		        .withYoungestChildDOB("").withLMP("").withEDD("").withHeight("").withBloodGroup("").withIsHRP("")
		        .withANCVisits(ancVisitsList).withIFATablets(ifaTabletsList).withTTDoses(ttDosesList)
		        .withHBTests(hbTestsList).withANCInvestigations(ancInvestigationsList);
