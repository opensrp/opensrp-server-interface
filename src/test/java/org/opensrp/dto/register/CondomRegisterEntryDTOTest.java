...
public class CondomRegisterEntryDTOTest {
	...
	public void testToString() {
		...
		CondomRegisterEntryDTO condomRegisterEntryDTO = new CondomRegisterEntryDTO().withEcNumber("").withWifeName("akhi")
		        .withHusbandName("").withVillage("gangapur").withSubCenter("nandanpur").withWifeAge("16").withCaste("")
		        .withReligion("").withNumberOfLivingMaleChildren("").withNumberOfLivingFemaleChildren("")
		        .withHusbandEducationLevel("").withWifeEducationLevel("").withFpDetails(condomFPDetailsDTO);
