...
public class PNCVisitDTOTest {
	...
	public void testToStringAndSetters() {
		...
		PNCVisitDTO pncVisitDTO = new PNCVisitDTO().withDate("").withPerson(person).withPlace(place).withDifficulties("")
		        .withAbdominalProblems("").withVaginalProblems("").withUrinalProblems("").withBreastProblems("")
