...
public class ServiceProvidedReportDTO {
	...
	public ServiceProvidedReportDTO(Integer id, String anm_identifier, String type, String indicator,
	    LocalDate reported_date, String village, String sub_center, String phc, String taluka, String district,
	    String state) {
		this.id = id;
