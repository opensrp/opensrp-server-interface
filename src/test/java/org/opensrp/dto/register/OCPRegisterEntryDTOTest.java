...
public class OCPRegisterEntryDTOTest {
	...
	public void testToStringAndSetters() {
		...
		OCPRegisterEntryDTO ocpRegisterEntryDTO = new OCPRegisterEntryDTO().withEcNumber("").withWifeName("")
		        .withWifeAge(wifeAge).withWifeEducationLevel("").withHusbandName(husbandName).withHusbandEducationLevel("")
		        .withVillage("charpara").withSubCenter("").withReligion("islam").withNumberOfLivingFemaleChildren("")
		        .withNumberOfLivingMaleChildren("").withCaste("").withLmpDate("").withUptResult("")
